...
import { User, Mail, Lock, UserCheck, Hash, Eye, EyeOff } from "lucide-react";
...
function StudentLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:5000/api/candicate/login", form);
      
      // Store user details in localStorage
      localStorage.setItem("candicate", JSON.stringify({
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-800">Candicate Login</h2>
